<template>
    <div class="panel-body">
        <div class="panel-list">
            <div class="list-item" v-for="item in soundslist" :key="item.id">
                <div class="cover">
...
export default {
    ...
    mounted(){
        ...
        this.$axios(`/ajax/mobileWeb/catalogmenu?order=3&cid=${this.sonlistid}&page_size=4`).
        then(res=>{
            // console.log(res.data.info.Datas)
            this.soundslist = res.data.info.Datas
        })
    }
}
</script>
